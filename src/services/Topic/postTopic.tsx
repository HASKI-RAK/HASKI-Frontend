...
export const postTopic = async ({ courseId, lmsCourseId, outputJson }: PostTopicProps): Promise<Topic> => {
  return fetchData<Topic>(`${getConfig().BACKEND}/lms/course/${courseId}/${lmsCourseId}/topic`, {
    method: 'POST',
    credentials: 'include',
    headers: {
