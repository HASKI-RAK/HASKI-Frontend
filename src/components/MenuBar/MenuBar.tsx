import { AppBar, Toolbar, Typography, Box, IconButton, Menu, Tooltip, Avatar, MenuItem, Grid, Button, Popover, Link, Divider } from "@mui/material";
...
const topics = [
    {
        ...
        , subtopics: ['Adapter', 'Builder', 'Command', 'Facade', 'Compositum', 'Singleton', 'Strategy', 'Template method', 'State']
    },
    {
        name: 'Metrics',
        subtopics: ['Cyclomatic complexity', 'Cohesion', 'Coupling', 'Halstead complexity', 'Lines of code', 'Nesting depth', 'Size', 'Weighted methods per class']
    }
]
                    ...
                    <Box sx={{ flexGrow: 0, mr: { xs: 0, md: 2 } }}>
                        <Tooltip title="Open topics">
                            <Button
                                ...
                                color="inherit"
                                endIcon={anchorElTopics ? <ArrowDropDownIcon sx={{ transform: 'rotate(180deg)' }} /> : <ArrowDropDownIcon />}
                            >
                                Topics
                            </Button>
                        </Tooltip>
