...
describe('Filter tests', () => {
    ...
    test('Single option can be selected', () => {
        ...
        expect(mockFilterProps.setSelectedOptions).toHaveBeenCalledWith([...mockFilterProps.selectedOptions, menuItems[0].textContent])
    })
    ...
    test('Multiple options can be selected', () => {
        ...
        expect(mockFilterProps.setSelectedOptions).toHaveBeenCalledWith([...mockFilterProps.selectedOptions, menuItems[2].textContent])
