  ...
  return (
    <>
      ...
      <Typography variant="body2">
        {' '}
        Im Rahmen des HASKI-Projekts beschäftigten sich die OTH Regensburg, HS Kempten und die TH Aschaffenburg damit,
        wie künstliche Intelligenz zur Unterstützung von Studierenden beim Lernen eingesetzt werden kann. Ziel des
        Projekts ist es, ein adaptives Learning Management System zu erstellen, welches die Lernenden mit den für sie
        bestmöglichen Lernmaterialien versorgt. Die erste Version dieses Systems, bezeichnet als HASKI Alpha, soll nun
        getestet werden im Hinblick auf den Einfluss von lernstilbasierten Lernpfaden auf die Motivation, das Interesse
        und den Wissensstand der teilnehmenden Studierenden. Der Fokus liegt dabei auf den unterschiedlichen
        Algorithmen, welche den Lernpfaden zugrunde liegen. Diese Vorgehensweise wird in der Ihnen vorliegenden Studie
        erstmals eingesetzt und getestet.
      </Typography>
      <Typography paragraph variant="body2" />
      <Divider />
      ...
      <Typography variant="body2">
        ...
        Bei Rückfragen oder Verständnisschwierigkeiten wenden Sie sich an den Studienleiter. Wir danken Ihnen für Ihre
        Mitwirkung und Ihr Vertrauen in unsere Arbeit! Wir arbeiten nach den Vorschriften der
        Datenschutz-Grundverordnung und allen anderen datenschutzrechtlichen Bestimmungen. Im Rahmen dieser Studie
      ...
      <Typography variant="body2">
        Die Datenerhebungen werden von entsprechend geschulten MitarbeiterInnen des HASKI-Projekts betreut und online
        mittels Moodle und dem HASKI-System durchgeführt. Bei Fragen zum jeweiligen Erhebungsverfahren oder bezüglich
        weiterführender Informationen können Sie sich jederzeit an die nachfolgend genannten Kontaktpersonen wenden. Die
        erhobenen Daten werden im weiteren Verlauf ausschließlich vertraulich verarbeitet.
      </Typography>
      <Typography paragraph variant="body2" />
      ...
      <Typography variant="body2">
        ...
        MitarbeiterInnen des HASKI-Projekts zugänglich gemacht. Die in dieser Studie erhobenen Daten werden im Sinne
        guter wissenschaftlicher Praxis in anonymisierter Form in einem vertrauenswürdigen Archiv aufbewahrt und von
        anderen WissenschaftlerInnen genutzt. Die anonymisierten Daten werden unter kontrollierten Bedingungen auch im
        Rahmen der Lehre eingesetzt. Seitens des Projekts HASKI werden Ihre Daten für maximal 10 Jahre aufbewahrt und
        nach Ablauf dieses Zeitraums unwiederbringlich gelöscht.
      </Typography>
      <Typography paragraph variant="body2" />
      ...
      <List>
        <ListItem>
          ...
          <ListItemText
            primary="Art. 7 Abs. 3 DSGVO - Recht auf Widerruf der Einwilligung: Sie haben das Recht, Ihre Einwilligung
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Art. 15 DSGVO - Auskunftsrecht: Sie haben uns gegenüber das Recht, Auskunft darüber zu erhalten,
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Art. 16 DSGVO - Recht auf Berichtigung: Sollten die Sie betreffenden Daten nicht richtig oder
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Art. 18 DSGVO - Recht auf Einschränkung der Verarbeitung: Sie können die Einschränkung der
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Art. 21 DSGVO - Widerspruchsrecht:  Sie können jederzeit gegen die Verarbeitung der Sie
        ...
        <ListItem>
          ...
          <ListItemText
            primary="Art. 77 DSGVO - Recht auf Beschwerde bei einer Aufsichtsbehörde: Wenn Sie der Auffassung sind,
      ...
      <Typography variant="body2">
        In jedem Fall gilt: Ihre Teilnahme an den Erhebungen ist freiwillig. Sie haben jederzeit die Möglichkeit zu
        widerrufen. Durch Verweigerung oder Widerruf entstehen Ihnen keine Nachteile.
      </Typography>
      <Typography variant="body2">
      ...
      <Typography paragraph variant="body2" />
      <Typography variant="body2">
        Bei Rückfragen zur Studie, wenden Sie sich bitte an den Versuchsleiter. Im Falle dieser Studie handelt es sich
        dabei um:
      </Typography>
      <Typography variant="body2" />
