...
export { default as TableILS } from './Questionnaire/TableILS'
export { default as GraphILS } from './Questionnaire/GraphILS'
export { default as ResultDescriptionILS } from './Questionnaire/ResultDescriptionILS'
export { default as TableListK } from './Questionnaire/TableListK'
export { default as GraphListK } from './Questionnaire/GraphListK'
export { default as ResultDescriptionListK } from './Questionnaire/ResultDescriptionListK'
export { default as QuestionnaireResultsModal } from './Questionnaire/QuestionnaireResultsModal'
