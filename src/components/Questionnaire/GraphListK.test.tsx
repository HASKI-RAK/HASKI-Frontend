...
describe('Test GraphListK with all Methods', () => {
  ...
  test('GraphListK renders correctly', async () => {
    ...
    expect(
      graphListK.getAllByText(
        'components.QuestionnaireResults.ResultDescriptionListK.Score' +
          ': ' +
  ...
  test('All bigger subscales are in graph', () => {
    ...
    const cognitiveStrategiesNode = container.querySelector(
      `circle[data-testid='node.components.QuestionnaireResults.TableListK.Cognitive strategies']`
    )
    const InternResNode = container.querySelector(
      `circle[data-testid='node.components.QuestionnaireResults.TableListK.Internal resource management strategies']`
    )
    ...
    const ExternalResNode = container.querySelector(
      `circle[data-testid='node.components.QuestionnaireResults.TableListK.External resource management strategies']`
    )
