...
describe('Test ResultDescriptionILS with all Score combinations', () => {
  test('all positive dimensions are balanced', () => {
    ...
    expect(container.innerHTML.substring(251, 251 + 'EverythingBalanced'.length)).toBe(
      'EverythingBalanced'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is active & moderate', () => {
    ...
    expect(container.innerHTML.substring(246, 246 + 'Active.moderate'.length)).toBe(
      'Active.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is reflective & moderate', () => {
    ...
    expect(container.innerHTML.substring(250, 250 + 'Reflective.moderate'.length)).toBe(
      'Reflective.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is reflective & strong', () => {
    ...
    expect(container.innerHTML.substring(250, 250 + 'Reflective.strong'.length)).toBe(
      'Reflective.strong'
    )
  })
  ...
  test('3 dimensions do not matter, 1 Dimension is reflective & balanced', () => {
    ...
    expect(container.innerHTML.substring(1198, 1198 + 'SomethingBalanced.processing'.length)).toBe(
  ...
  test('3 dimensions are balanced, 1 Dimension is sensory & moderate', () => {
    ...
    expect(container.innerHTML.substring(247, 247 + 'Sensory.moderate'.length)).toBe(
      'Sensory.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is intuitive & moderate', () => {
    ...
    expect(container.innerHTML.substring(249, 249 + 'Intuitive.moderate'.length)).toBe(
      'Intuitive.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is intuitive & strong', () => {
    ...
    expect(container.innerHTML.substring(249, 249 + 'Intuitive.strong'.length)).toBe(
      'Intuitive.strong'
    )
  })
  ...
  test('3 dimensions do not matter, 1 Dimension is intuitive & balanced', () => {
    ...
    expect(container.innerHTML.substring(1196, 1196 + 'SomethingBalanced.perception'.length)).toBe(
  ...
  test('3 dimensions are balanced, 1 Dimension is visual & moderate', () => {
    ...
    expect(container.innerHTML.substring(246, 246 + 'Visual.moderate'.length)).toBe(
      'Visual.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is verbal & moderate', () => {
    ...
    expect(container.innerHTML.substring(246, 246 + 'Verbal.moderate'.length)).toBe(
      'Verbal.moderate'
    )
  })
  ...
  test('3 dimensions do not matter, 1 Dimension is verbal & balanced', () => {
    ...
    expect(
      container.innerHTML.substring(1198, 1198 + 'SomethingBalanced.presentation'.length)
    ).toBe('SomethingBalanced.presentation')
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is sequential & moderate', () => {
    ...
    expect(container.innerHTML.substring(250, 250 + 'Sequential.moderate'.length)).toBe(
      'Sequential.moderate'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is sequential & strong', () => {
    ...
    expect(container.innerHTML.substring(250, 250 + 'Sequential.strong'.length)).toBe(
      'Sequential.strong'
    )
  })
  ...
  test('3 dimensions are balanced, 1 Dimension is global & moderate', () => {
    ...
    expect(container.innerHTML.substring(246, 246 + 'Global.moderate'.length)).toBe(
      'Global.moderate'
    )
  })
  ...
  test('3 dimensions do not matter, 1 Dimension is global & balanced', () => {
    ...
    expect(
      container.innerHTML.substring(1190, 1190 + 'SomethingBalanced.organisation'.length)
    ).toBe('SomethingBalanced.organisation')
  })
  ...
  test('all dimensions moderate positive', () => {
    ...
    expect(container.innerHTML.substring(518, 518 + 'Sensory.moderate'.length)).toBe(
      'Sensory.moderate'
    )
    expect(container.innerHTML.substring(246, 246 + 'Active.moderate'.length)).toBe(
      'Active.moderate'
    )
    expect(container.innerHTML.substring(790, 790 + 'Visual.moderate'.length)).toBe(
      'Visual.moderate'
    )
    expect(container.innerHTML.substring(1065, 1065 + 'Sequential.moderate'.length)).toBe(
      'Sequential.moderate'
    )
  })
  ...
  test('all dimensions strong positive', () => {
    ...
    expect(container.innerHTML.substring(1059, 1059 + 'Sequential.strong'.length)).toBe(
      'Sequential.strong'
    )
  })
  ...
  test('all dimensions moderate negative', () => {
    ...
    expect(container.innerHTML.substring(528, 528 + 'Intuitive.moderate'.length)).toBe(
      'Intuitive.moderate'
    )
    expect(container.innerHTML.substring(250, 250 + 'Reflective.moderate'.length)).toBe(
      'Reflective.moderate'
    )
    expect(container.innerHTML.substring(802, 802 + 'Verbal.moderate'.length)).toBe(
      'Verbal.moderate'
    )
    expect(container.innerHTML.substring(1073, 1073 + 'Global.moderate'.length)).toBe(
      'Global.moderate'
    )
  })
  ...
  test('all dimensions strong negative', () => {
    ...
    expect(container.innerHTML.substring(526, 526 + 'Intuitive.strong'.length)).toBe(
      'Intuitive.strong'
    )
    expect(container.innerHTML.substring(250, 250 + 'Reflective.strong'.length)).toBe(
      'Reflective.strong'
  ...
  test('Switch default case', () => {
    ...
    const getILSDimension = jest
      .fn()
      .mockImplementation((dim: number, score: number, something?: boolean) => {
        // eslint-disable-next-line @typescript-eslint/no-unused-vars
