...
export const TableListK = () => {
    ...
    const rows = [
        {
            id: 1,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Factors & subscales"),
            col2: t("components.Questionnaire.QuestionnaireResults.TableListK.Score"),
        },
        {
            id: 2,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Cognitive strategies"),
            col2: (Math.round((averageCognitiveStrategies + Number.EPSILON) * 100) / 100).toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Internal resource management strategies"),
            col4: (Math.round((averageInternalResourceManagementStrategies + Number.EPSILON) * 100) / 100).toFixed(2),
        },
        {
            id: 3,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Organize"),
            col2: organize.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Attention"),
            col4: attention.toFixed(2),
        },
        {
            id: 4,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Elaborate"),
            col2: elaborate.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Effort"),
            col4: effort.toFixed(2),
        },
        {
            id: 5,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Critical review"),
            col2: criticalReview.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Time"),
            col4: time.toFixed(2),
        },
        {
            id: 6,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Repeat"),
        ...
        {
            id: 7,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Metacognitive strategies"),
            col2: (Math.round((averageMetacognitiveStrategies + Number.EPSILON) * 100) / 100).toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.External resource management strategies"),
            col4: (Math.round((averageExternalResourcesManagementStrategies + Number.EPSILON) * 100) / 100).toFixed(2),
        },
        {
            id: 8,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Goals & plans"),
            col2: goalsPlans.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Learning with classmates"),
            col4: learnWithClassmates.toFixed(2),
        },
        {
            id: 9,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Control"),
            col2: control.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Literature research"),
            col4: literatureResearch.toFixed(2),
        },
        {
            id: 10,
            col1: t("components.Questionnaire.QuestionnaireResults.TableListK.Regulate"),
            col2: regulate.toFixed(2),
            col3: t("components.Questionnaire.QuestionnaireResults.TableListK.Learning environment"),
