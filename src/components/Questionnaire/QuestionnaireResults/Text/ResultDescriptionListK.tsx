...
const useGeneralSubscalesBelow3Element = (generalProps: GeneralSubscalesProps): JSX.Element => {
    ...
    if(averageSubscaleBelow3Array.length > 1) {
        averageSubscaleBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.SubscaleAverage Below3." + averageSubscaleBelow3Array.length);
    }
...
const useCognitiveStrategiesBelow3Element = (generalProps: CognitiveStrategiesProps) => {
    ...
    let cognitiveStrategiesBelow3String = t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.CognitiveStrategies Below3.Part1");
    ...
    if(generalProps.organize < 3) {
        ...
        cognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Table.TableListK.Organize") + " &";
    }
    if(generalProps.elaborate < 3) {
        cognitiveStrategiesBelow3Array.push("Elaborate");
        cognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Table.TableListK.Elaborate") + " &";
    }
    if(generalProps.criticalReview < 3) {
        cognitiveStrategiesBelow3Array.push("Critical review");
        cognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Table.TableListK.Critical review") + " &";
    }
    if(generalProps.repeat < 3) {
        cognitiveStrategiesBelow3Array.push("Repeat");
        cognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Table.TableListK.Repeat") + " &";
    }
    ...
    if(cognitiveStrategiesBelow3Array.length > 0) {
        cognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.CognitiveStrategies Below3.Part2");
...
const useMetacognitiveStrategiesBelow3Element = (metacognitiveProps: MetaCognitiveStrategiesProps) => {
    ...
    let metacognitiveStrategiesBelow3String = t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.MetacognitiveStrategies Below3.Part1");
    ...
    if(metacognitiveProps.goalsPlans < 3) {
        ...
        metacognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.MetacognitiveStrategies Below3.Goals & Plans") + " &";
    }
    if(metacognitiveProps.control < 3) {
        metacognitiveStrategiesBelow3Array.push("Control");
        metacognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Table.TableListK.Control") + " &";
    }
    if(metacognitiveProps.regulate < 3) {
        metacognitiveStrategiesBelow3Array.push("Regulate");
        metacognitiveStrategiesBelow3String += " " + t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK.MetacognitiveStrategies Below3.Regulate") + " &";
    }
    ...
    if(subscalesBelow3Array.length > 0) {
        ...
        subscalesBelow3MessageString.push(
            <div key={"RelevantSubscalesBelow3DescriptionListK"}>
                <Typography variant={"h6"} gutterBottom>
                    {t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK."+ subscalesBelow3Array.join("") +" Below3.Title")}
                </Typography>
                <Typography variant="body2" gutterBottom>
                    {t("components.Questionnaire.QuestionnaireResults.Text.ResultDescriptionListK."+ subscalesBelow3Array.join("") +" Below3.Description")}
                </Typography>
            </div>
        );
    }
