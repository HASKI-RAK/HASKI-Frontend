...
describe("TableListKQuestions", () => {
    test("ListK RadioButtons can be checked", () => {
        ...
        const RadioButton1 = getByTestId('ListKQuestionnaireButtonGroup1').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton1);

        const RadioButton2 = getByTestId('ListKQuestionnaireButtonGroup2').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton2);

        const RadioButton3 = getByTestId('ListKQuestionnaireButtonGroup3').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton3);

        const RadioButton4 = getByTestId('ListKQuestionnaireButtonGroup4').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton4);

        const RadioButton5 = getByTestId('ListKQuestionnaireButtonGroup5').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
    ...
    test("ListK next Button is enabled, when all radioButtons are selected (2 Pages)", () => {
        ...
        const RadioButton6 = getByTestId('ListKQuestionnaireButtonGroup1').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton6);

        const RadioButton7 = getByTestId('ListKQuestionnaireButtonGroup2').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton7);

        const RadioButton8 = getByTestId('ListKQuestionnaireButtonGroup3').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton8);

        const RadioButton9 = getByTestId('ListKQuestionnaireButtonGroup4').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        fireEvent.click(RadioButton9);

        const RadioButton10 = getByTestId('ListKQuestionnaireButtonGroup5').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
    ...
    test("ListK values are stored", () => {
        ...
        const RadioButton2 = getByTestId('ListKQuestionnaireButtonGroup2').querySelectorAll('input[type="radio"]')[1] as HTMLInputElement;
        fireEvent.click(RadioButton2);

        const RadioButton3 = getByTestId('ListKQuestionnaireButtonGroup3').querySelectorAll('input[type="radio"]')[2] as HTMLInputElement;
        fireEvent.click(RadioButton3);

        const RadioButton4 = getByTestId('ListKQuestionnaireButtonGroup4').querySelectorAll('input[type="radio"]')[3] as HTMLInputElement;
        fireEvent.click(RadioButton4);

        const RadioButton5 = getByTestId('ListKQuestionnaireButtonGroup5').querySelectorAll('input[type="radio"]')[4] as HTMLInputElement;
        fireEvent.click(RadioButton5);
        ...
        const RadioButton1Back = getByTestId('ListKQuestionnaireButtonGroup1').querySelectorAll('input[type="radio"]')[0] as HTMLInputElement;
        const RadioButton2Back = getByTestId('ListKQuestionnaireButtonGroup2').querySelectorAll('input[type="radio"]')[1] as HTMLInputElement;
        const RadioButton3Back = getByTestId('ListKQuestionnaireButtonGroup3').querySelectorAll('input[type="radio"]')[2] as HTMLInputElement;
        const RadioButton4Back = getByTestId('ListKQuestionnaireButtonGroup4').querySelectorAll('input[type="radio"]')[3] as HTMLInputElement;
        const RadioButton5Back = getByTestId('ListKQuestionnaireButtonGroup5').querySelectorAll('input[type="radio"]')[4] as HTMLInputElement;
